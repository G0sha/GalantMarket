...
class SolutionsControllerTest < ActionController::TestCase
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post :create, solution: { description: @solution.description, price: @solution.price, sol_img: @solution.sol_img, title: @solution.title }
    end
  ...
  test "should update solution" do
    patch :update, id: @solution, solution: { description: @solution.description, price: @solution.price, sol_img: @solution.sol_img, title: @solution.title }
    assert_redirected_to solution_path(assigns(:solution))
  end
